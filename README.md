...
### 真实大宇宙收益回测（2018-2026，沪深300 298 只）

> 完整报告：[`out/backtest-split.md`](out/backtest-split.md)（样本内/外 + 分市场状态）
> 数据说明：行情从 2013 起、财报公告日最早 2017-01，**2018 之前无法回填股本（市值恒空）**，
> 故回测区间取 2018-01 ~ 2026-09；298/300 只（2 只接口取不到）。

| 指标 | 全期 | 样本内 2018-2021 | 样本外 2022-2026 |
|---|---|---|---|
| 策略年化 | 11.16% | 15.44% | 9.53% |
| 等权基准 | 14.07% | 21.86% | 14.00% |
| **年化超额** | **-2.91%** | **-6.42%** | **-4.47%** |
| 年化波动 | 13.26% | 13.72% | 13.16% |
| 夏普 | 0.92 | 1.19 | 0.80 |
...
**诚实结论：策略未跑赢等权基准。** 它是一个「低风险版本」而非「超额收益来源」——
波动比基准低约 5pp、回撤仅基准的 60%，但夏普与基准相当（样本外 0.80 vs 0.80），
信息比率 -0.51 ~ -0.87。价值因子在成长牛与 AI 行情中持续逆风，熊市才体现防御性。
