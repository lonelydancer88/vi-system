...
| 档位 | 年化收益 | 年化超额 | 区间总收益 | 最大回撤 | 夏普 | 胜率(对基准) | 平均持仓 |
|------|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **Top30** | +11.7% | −1.4% | +179.4% | −13.07% | 0.98 | 46.4% | 29.1 |
| **Top5** | **+13.9%** | **+0.9%** ✅ | +235.7% | −17.00% | 0.91 | **57.1%** | 5.0 |
| **Top3** | +12.1% | −1.0% | +189.0% | −27.44% | 0.70 | 46.4% | 3.0 |
| 等权基准 | +13.0% | — | +213.0% | −19.51% | — | — | — |
...
1. **集中（Top5）是唯一跑赢等权基准的档位**：年化超额 +0.9%、胜率 57.1%。
   分散到 30 只时超额转负（−1.4%），过度集中到 3 只则回撤扩大到 −27%。
2. **回撤全面优于基准**：三档最大回撤 −13% ~ −27%，均小于等权基准的 −19.5%，
   印证了它作为"低风险版本"而非"超额收益来源"的定位。
...
| 指标 | Top30 | Top5 | Top3 | 等权基准 |
|---|---|---|---|---|
| 年化收益 | +11.7% | **+13.9%** | +12.1% | +13.0% |
| 年化超额 | −1.4% | **+0.9%** | −1.0% | — |
| 区间总收益 | +179.4% | +235.7% | +189.0% | +213.0% |
| 最大回撤 | −13.07% | −17.00% | −27.44% | −19.51% |
| 夏普 | 0.98 | 0.91 | 0.70 | — |
| 胜率(对基准) | 46.4% | **57.1%** | 46.4% | — |
| 平均持仓数 | 29.1 | 5.0 | 3.0 | — |

**诚实结论：Top5 是唯一跑赢等权基准的档位**，但幅度很小（+0.9% 年化超额），且以更大回撤（−17% vs −19.5%）为代价。
其余档位均小幅跑输基准。它是一个「低风险版本」而非「超额收益来源」——
波动比基准低、回撤均小于基准，但信息比率接近 0。价值因子在成长牛与 AI 行情中持续逆风，熊市才体现防御性。

需注意：基准是**等权宇宙**，A 股等权本身含小盘/反转溢价，是较难超越的基准；
设计文档指定的真实基准（中证红利质量 / 红利低波）需外部数据，尚未接入——
换成该基准后结论可能不同，这是下一步该补的检验。
